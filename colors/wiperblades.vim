...
highlight Visual                    term=NONE      cterm=NONE      ctermfg=white       ctermbg=black        gui=NONE      guifg=white     guibg=black
highlight VisualNOS                 term=underline cterm=underline ctermfg=white       ctermbg=black        gui=underline guifg=white     guibg=black
